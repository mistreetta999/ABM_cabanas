""" archivo handlers.py: contiene las funciones que manejan las solicitudes HTTP para la aplicación de gestión de cabañas. """
from django.http import HttpResponse, JsonResponse
class handlers:
    """Clase handlers para manejar las solicitudes HTTP."""
    def __init__(self):
        pass
# -------------------
# PÁGINA PRINCIPAL
