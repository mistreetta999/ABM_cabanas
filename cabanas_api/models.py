...
class Reserva(models.Model):
    ...
    Cabanas= models.ForeignKey(Cabana, on_delete=models.CASCADE, related_name="reservas")
...
class Factura(models.Model):
    ...
    cabana = models.ForeignKey(Cliente, on_delete=models.CASCADE, related_name="facturas")
