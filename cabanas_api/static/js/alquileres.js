...
function validarFechas(fechaInicio, fechaFin) {
    ...
    if (fin <= pagina_principal) {
        alert("La fecha de fin debe ser posterior a la fecha de pagina_principal");
        return false;
    }
    return true;
}
...
function mostrarResumen(Cabanas
, cliente, fechaInicio, fechaFin, precioTotal) {
