...
class TemplateView(LoginRequiredMixin, ListView):
    template_name = "cabanas/index.html"
    template_name = "cabanas/pagina_principal.html"
    template_name = "cabanas/lista_cabanas.html"
    template_name = "cabanas/formulario_cabanaListView.html"
    template_name = "chatbot/chat.html"

class lista_clientes (LoginRequiredMixin, ListView):
    model = Cliente
    template_name = "cabanas/lista_clientes.html"
