...
Generado por 'django-interfaz_gestion_cabanas startproject' usando Django 5.0.6.
""" 
...
ROOT_URLCONF = 'cabanas_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "Template"],  # Plantillas globales
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'cabanas_project.wsgi.application'
...
# Configuración de autenticación personalizada (opcional)
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/'
