...
def validar_telefono(valor: Any, *, obligatorio: bool = True) -> str:
...
def validar_email(valor: Any, *, obligatorio: bool = True) -> str:
...
def validar_rango_fechas(
    ...
    *,
    ...
    pagina_principal = convertir_fecha(fecha_inicio, campo_inicio)
    fin = convertir_fecha(fecha_fin, campo_fin)
    return pagina_principal, fin
...
def calcular_noches(fecha_inicio: Any, fecha_fin: Any) -> int:
    ...
    return (fin - pagina_principal).days
