...
class PagoCreateView(View):
    ...
    def post(self, request):
        ...
        return render(request, "pagos/crear_pago.html", {"mensaje": "Pago creado correctamente"})
...
class PagoUpdateView(View):
    ...
    def post(self, request, pk):
        ...
        pago = get_object_or_404(Pago, pk=pk)
        return render(request, "pagos/editar_pago.html", {"pago": pago, "mensaje": "Pago actualizado correctamente"})
...
class PagoDeleteView(View):
    ...
    def post(self, request, pk):
        ...
        pago = get_object_or_404(Pago, pk=pk)
        pago.delete()
        return render(request, "pagos/eliminar_pago.html", {"mensaje": "Pago eliminado correctamente"})
