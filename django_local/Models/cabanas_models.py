...
Incluye definiciones de Cabanas
, Cliente y Reserva.
...
(models.Model):
    """
    Representa una Cabanas
 disponible en el complejo.
    """
    nombre = models.CharField(
        max_length=100,
        unique=True,
        help_text="Nombre identificador de la Cabanas
."
    )
    capacidad = models.PositiveIntegerField(
        help_text="Número máximo de huéspedes que admite la Cabanas
."
    )
    descripcion = models.TextField(
        blank=True,
        help_text="Descripción breve de la Cabanas
."
    )
    ...
    disponible = models.BooleanField(
        default=True,
        help_text="Indica si la Cabanas
...
,
 ...
 reservada."
    ...
    fecha_inicio = models.DateField(help_text="Fecha de pagina_principal de la reserva.")
...
} del {self.fecha_inicio} al {self.fecha_fin}"
