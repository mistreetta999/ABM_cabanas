...
class Reserva(models.Model):
    ...
    def __str__(self):
        ...
        if cliente is None:
            ...
            cliente_nombre = f"{getattr(cliente, 'nombre', '')} {getattr(cliente, 'apellido', '')}".strip()
        return f"Reserva {self.id} - Cliente: {cliente_nombre} - Estado: {self.estado}"    
...
class Alquiler(models.Model):
    ...
    def __str__(self):
        ...
        if cliente is None:
            ...
            cliente_nombre = f"{getattr(cliente, 'nombre', '')} {getattr(cliente, 'apellido', '')}".strip()
        return f"Alquiler {self.id} - Cliente: {cliente_nombre}"
